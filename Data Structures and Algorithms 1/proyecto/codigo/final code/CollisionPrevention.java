...
public class CollisionPrevention {
    ...
    public double getDistanceBetween(double average) {
        return -3 * Math.pow(10, -9) * Math.pow(average, 6) - 2 * Math.pow(10, -7) * Math.pow(average, 5) 
	+ 0.0004 * Math.pow(average, 4) - 0.0005 * Math.pow(average, 3) - 16.948 * Math.pow(average, 2) - 
	0.0463 * average + 111325;
    }
